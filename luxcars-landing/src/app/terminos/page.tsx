    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 w-full px-4 pb-20 pt-32 sm:px-8 lg:px-12">
        ...
        <div className="space-y-8 rounded-3xl border border-white/10 bg-white/[0.04] p-8 text-white/70">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white">3. Responsabilidades del Cliente</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white">4. Precios y Pagos</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white">8. Modificaciones</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white">9. Ley Aplicable y Jurisdicción</h2>
            <p>
